...
1.  **Reconocimiento:** Introduce una IP (ej: `192.0.2.1` o `203.0.113.1`) o un dominio de red. Selecciona el perfil del nivel de alerta y da a Iniciar. Si la red es Pública y detecta puertos peligrosos, lanzará una alerta roja estroboscópica.
